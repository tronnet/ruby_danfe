  ...
  class DanfeNfceGenerator
    ...
    def render_totais  
      ...
      @pdf.ibox 2, 12, 0.9, 16.7, '',
        "QTD. TOTAL DE ITENS:" + "\n" + "FORMA DE PAGAMENTO:" + "\n" + "VALOR TOTAL (R$):" + "\n" + "VALOR PAGO (R$):", {align: :left, valign: :right, size: 6, border: 0, style: :bold}
      @pdf.ibox 2, 12, 0.9, 16.7, '',
        "#{qtde_produtos}" + "\n" + "#{forma_pgto}" + "\n" + "#{valor_total}" + "\n" + "#{vlr_pago}", {align: :right, valign: :right, size: 6, border: 0, style: :bold}
    end
    ...
    def render_qrcode      
      @pdf.iqrcode 1.7, 8.2, 6.2, 25, get_qrcode_url      
    end
